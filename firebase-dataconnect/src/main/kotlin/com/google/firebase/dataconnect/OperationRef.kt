...
public interface OperationRef<Data, Variables> {
   ...
   * names corresponding to the given arguments changed to the respecitve argument's value.
   *
  ...
  /**
   * Creates and returns a new object that is a _copy_ of this object, but with the
   * [OperationRef.variables] and [OperationRef.variablesSerializer] properties set to the given
   * [variables] and [variablesSerializer] arguments, respectively.
   *
   * This function is essentially the same as [copy] except that is enables changing the `Variables`
   * type parameter, where the [copy] method does not.
   *
   * @see copy
   * @see withDataDeserializer
   */
  ...
  /**
   * Creates and returns a new object that is a _copy_ of this object, but with the
   * [OperationRef.dataDeserializer] property set to the given [dataDeserializer] argument.
   *
   * This function is essentially the same as [copy] except that is enables changing the `Data` type
   * parameter, where the [copy] method does not.
   *
   * @see copy
   * @see withVariables
   */
