...
class StubOperationRefImplUnitTest {
  ...
  @Test
  fun `withVariables() should return an equal object, except for the given arguments`() {
    val stubOperationRefImpl1 = Arb.dataConnect.stubOperationRefImpl().next(rs)
    ...
    val stubOperationRefImpl2 =
      stubOperationRefImpl1.withVariables(
  ...
  @Test
  fun `withVariables() should properly handle variablesSerializersModule=null`() {
    val stubOperationRefImpl1 = Arb.dataConnect.stubOperationRefImpl().next(rs)
    val newVariables: StubVariables2 = mockk()
    val newVariablesSerializer: SerializationStrategy<StubVariables2> = mockk()
  ...
  @Test
  fun `withVariables() should properly handle default argument values`() {
    val stubOperationRefImpl1 = Arb.dataConnect.stubOperationRefImpl().next(rs)
    val newVariables: StubVariables2 = mockk()
    val newVariablesSerializer: SerializationStrategy<StubVariables2> = mockk()
